...
@app.route('/diagnostic/gpu', methods=['GET'])
def gpu_diagnostic():
    """Diagnostic endpoint to check GPU environment in Flask context."""
    import io
    import sys
    import os
    import platform
    ...
    try:
        ...
        def run_execution_context_test():
            ...
            print("Execution Mode: Flask endpoint")
        ...
        # Run the diagnostic
        print("GPU Environment Diagnostic Tool - Flask Context")
        ...
        print("\n" + "="*60)
        print(" Flask Context Diagnostic Complete")
        print("="*60)
    ...
    return Response(diagnostic_output, mimetype='text/plain')
